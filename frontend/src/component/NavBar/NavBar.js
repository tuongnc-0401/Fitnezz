        ...
        <div className={classes.root}>
            <AppBar position="static" className={classes.appBar}>
                <Toolbar style={{ padding: '0px' }}>
                    ...
                    <Typography style={{ display: 'inline-block'}} component={Link} to="/" variant='h6' color="inherit" className={ checkWidth < 810 ? classes.logoTitleNoPadding: classes.logoTitle }>
                        FITNEZZ
                    </Typography>

                    {
                        checkWidth < 810 && (<div style={{ width: '100%', height: '5px'}}></div>)
                    }
