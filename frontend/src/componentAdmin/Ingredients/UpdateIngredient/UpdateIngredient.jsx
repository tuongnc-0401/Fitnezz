...
import { detailsIngredient, updatedIngredients } from '../../../actions/ingredientActions';
...
const UpdateIngredient = () => {
    ...
    const { loading: updateLoading, error: updateError, success } = updateIngredient
    const [ingredientData, setIngredientData] = useState({
        name: '', image: '', calo: '', category: '', description: ''
    });
    const { id } = useParams()
