...
import { deletedIngredient, listIngredients } from '../../actions/ingredientActions';
                                            ...
                                            {ingredients.map((ingredient) => (
                                                <StyledTableRow key={ingredient._id}>
                                                    ...
                                                    <StyledTableCell align="center" component="th" scope="row">
                                                        <img width="50px" height="50px" src={ingredient.image} alt="ingredient"></img>
                                                    </StyledTableCell>
                                                    <StyledTableCell align="center">{ingredient.category}</StyledTableCell>
                                                    <StyledTableCell align="center">{ingredient.description}</StyledTableCell>
                                                    <StyledTableCell align="center">{ingredient.calo}</StyledTableCell>
                                                        ...
                                                        <Grid container spacing={2}>
                                                            <Grid item xs={12}>
                                                                <Button
                                                                    variant="contained"
                                                                    className={classes.pink}
                                                                    onClick={() => history.push(`/admin/ingredient/${ingredient._id}`)}
                                                                    fullWidth
                                                                >
                                                                    Update
                                                                </Button>
