...
const Admin = () => {
  ...
  const { loading: loadingIngredient, error: errorIngredient, ingredients } = ingredientList;
  const productListAll = useSelector(state => state.productListAll)
  const { loading: loadingProduct, error: errorProduct, products } = productListAll
  ...
  return (
    <>
      ...
      <div container className={classes.container}>
        ...
        <div className={classes.right} style={{ width: '100%', padding: '20px' }}>
