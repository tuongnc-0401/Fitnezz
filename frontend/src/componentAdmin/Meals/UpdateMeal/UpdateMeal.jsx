import { Button, CircularProgress, Container, CssBaseline, FormControl, FormControlLabel, FormLabel, Grid, Radio, RadioGroup, TextField, Typography } from '@material-ui/core';
            ...
            <div className={classes.paper}>
                ...
                {loading ? (
                    ...
                    <form className={classes.form} onSubmit={handleSubmit} noValidate>
                        {updateLoading && <CircularProgress style={{ marginTop: '10px' }} color="secondary" />}
                        {updateError && <Alert style={{ marginTop: '10px' }} severity="error">{error}</Alert>}
                        {success &&
                        ...
                        <FormControl component="fieldset" style={{ marginTop: '10px' }}>
                            ...
                            <RadioGroup aria-label="type" name="type" value={mealData?.type || ""} onChange={(e) => setMealData({ ...mealData, type: e.target.value })}>
                        ...
                        <Grid container>
                            ...
                            <Grid container justifyContent="flex-end" item xs={12} md={6} style={{ width: "100%" }}>
                                <select name="fruit" id="fruit" value={mealData?.fruit || ""} onChange={handleOnChange} required style={{ width: "100%" }}>
                        ...
                        <Grid container style={{ marginTop: "10px" }}>
                            ...
                            <Grid container justifyContent="flex-end" item xs={12} md={6} style={{ width: "100%" }}>
                                <select name="vegetable" id="vegetable" value={mealData?.vegetable || ""} onChange={handleOnChange} required style={{ width: "100%" }}>
                                    <option value="">Select one option</option>
                                    {ingredients.map((ingredient, index) => {
                        ...
                        <Grid container style={{ marginTop: "10px" }}>
                            ...
                            <Grid container justifyContent="flex-end" item xs={12} md={6} style={{ width: "100%" }}>
                                <select name="dairy" id="dairy" value={mealData?.dairy || ""} onChange={handleOnChange} required style={{ width: "100%" }}>
                                    <option value="">Select one option</option>
                        ...
                        <Grid container style={{ marginTop: "10px" }}>
                            ...
                            <Grid container justifyContent="flex-end" item xs={12} md={6} style={{ width: "100%" }}>
                                <select name="grain" id="grain" value={mealData?.grain || ""} onChange={handleOnChange} required style={{ width: "100%" }}>
                                    <option value="">Select one option</option>
                        ...
                        <Grid container style={{ marginTop: "10px" }}>
                            ...
                            <Grid container justifyContent="flex-end" item xs={12} md={6} style={{ width: "100%" }}>
                                <select name="protein" id="protein" value={mealData?.protein || ""} onChange={handleOnChange} required style={{ width: "100%" }}>
                                    <option value="">Select one option</option>
                        ...
                        <Grid container spacing={1} style={{ marginTop: "5px" }}>
                            <Grid item xs="12" md="6">
                                <Button component={changeURL} to="/admin/meal/" variant="outlined" fullWidth>Go Back</Button>
                            </Grid>
                            <Grid item xs="12" md="6">
