import { Box, Button, CircularProgress, Dialog, DialogActions, DialogTitle, Grid, Paper, Slide, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Typography, withStyles } from '@material-ui/core'
...
const Meals = () => {
    ...
    const { loading: loadingDelete, error: errorDelete, success: successDelete } = deleteMeal
                                    ...
                                    {meals.map((meal) => (
                                        <StyledTableRow key={meal._id}>
                                            ...
                                            <StyledTableCell align="center" component="th" scope="row">
                                                <img width="50px" height="50px" src={meal.image} alt="ingredient"></img>
                                            </StyledTableCell>
                                            <StyledTableCell align="center">{meal.ingredients}</StyledTableCell>
                                            <StyledTableCell align="center">{meal.instruction}</StyledTableCell>
